      ...
      {openIndex !== null && (
        ...
        >
          <button
            ...
            aria-label="Fechar"
            className="absolute right-6 top-6 z-[70] flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-white/20"
          >
            ✕
          </button>
