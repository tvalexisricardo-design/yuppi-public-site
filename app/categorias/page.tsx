...
export default function CategoriasPage() {
  const itemListJsonLd = {
    ...
    itemListElement: categories.map((cat, i) => ({
      ...
      position: i + 1,
      name: cat.name,
      url: `https://www.yuppi.pt/${cat.slug}`,
    })),
  };
      ...
      <section className="relative overflow-hidden px-6 pb-16 pt-16 md:pt-24">
        ...
        <div className="relative mx-auto max-w-content">
          ...
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-inkSoft">
            Da animação à decoração, organiza a tua pesquisa por categorias e descobre os profissionais disponíveis em cada área.
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-black/5 bg-canvasSoft px-6 py-20">
        <Reveal className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-3 text-inkSoft">
            Pede inclusão no diretório e começa a receber pedidos assim que o
